...
.stat-card.total-orders {
    ...
    border-left: 4px solid #4a90e2; /* Blue accent for Total Users */
}

.stat-card.total-delivered {
    background: linear-gradient(135deg, #e6f7e9 0%, #ffffff 100%);
    border-left: 4px solid #2ecc71; /* Green accent for Online Users */
}

.stat-card.pending-orders {
    background: linear-gradient(135deg, #ffe6e6 0%, #ffffff 100%);
    border-left: 4px solid #e74c3c; /* Red accent for Offline Users */
}

.stat-card.orders-on-hold {
    background: linear-gradient(135deg, #fff5e6 0%, #ffffff 100%);
    border-left: 4px solid #f1c40f; /* Yellow accent for Online Rate */
}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="user-status">
                                            ...
                                            echo htmlspecialchars($isOnline ? 'Online' : 'Offline');
                                            ?>
                                        </span>
                                    </td>
                                    <td>
