            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
                ...
                ?>
                  ...
                  ?>
                  <img
                    src="../../uploads/1743166799_13a6e7c7214158c4f676084788520266.jpg"
                    class="user-image rounded-circle shadow-sm me-2"
                    alt="User Image"
                    width="35"
                    height="35" />
...
=======
                        ...
                        <li class="nav-item dropdown user-menu">
                            <a href="#" class="nav-link dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
                                <?php
                                // Use session image directly, with fallback
                                ...
                                if (!file_exists($imagePath)) {
                                    $userImage = '/views/assets/img/user2-160x160.jpg'; // Final fallback
                                }
