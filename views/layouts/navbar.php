          ...
          <ul class="navbar-nav ms-auto">
           ...
           <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
                            ...
                            if (!$userImage || !file_exists($_SERVER['DOCUMENT_ROOT'] . $userImage)) {
                                $userImage = $_SESSION['user_image'] ?? $defaultImage;
                            }
                            if (!file_exists($_SERVER['DOCUMENT_ROOT'] . $userImage)) {
                                $userImage = $defaultImage; // Final fallback
                            }
                            ...
                            <span class="d-none d-md-inline text-dark fw-semibold">
                                <?php echo htmlspecialchars($fullName ?: $_SESSION['last_name'] ?: 'Unknown'); ?>
                            </span>
                        </a>
